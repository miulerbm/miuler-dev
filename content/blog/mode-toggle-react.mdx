...
We will use a Button component from Shadcn as well, which lets us pass it two elements as children. In this case, the elements will be two different icons: Sun and Moon from Lucide.
